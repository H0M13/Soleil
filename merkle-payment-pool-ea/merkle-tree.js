const { bufferToHex, toBuffer, setLengthLeft, keccak256 } = require('ethereumjs-util');
...
class MerkleTree {
  ...
  sha3 (node) {
    return Buffer.from(hexToBytes(soliditySha3({t: 'address', v: node["address"]}, {t: "uint256", v: node["earnings"] })))
  }
}
